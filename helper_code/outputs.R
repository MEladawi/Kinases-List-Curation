...
write_outputs <- function(kinases_table, unmapped_table, output_dir, source_manifest, build_date) {
  ...
  readme_lines <- c(
    ...
    "  kinase_group / kinase_subfamily : UniProt protein-family classification",
    "                        (actively curated); kinase_family is the Manning",
    "                        intermediate tier (KinHub/kinase.com). Each field is",
    "                        filled UniProt -> KinHub -> kinase.com (first available).",
